...
export declare class DappTransport {
    ...
    private readonly redirectUrlActionHandler?;
    readonly walletOrigin: string;
    constructor(walletUrl: string, mode?: TransportMode, popupModeOptions?: PopupModeOptions, sequenceSessionStorage?: SequenceSessionStorage, redirectUrlActionHandler?: (url: string) => void);
    get isWalletOpen(): boolean;
    get isReady(): boolean;
    sendRequest<TResponse = any, TRequest = any>(action: string, payload?: TRequest, options?: SendRequestOptions): Promise<TResponse>;
