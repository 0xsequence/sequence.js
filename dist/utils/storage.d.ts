...
import { AddExplicitSessionPayload, CreateNewSessionPayload, ModifySessionPayload, LoginMethod, SignMessagePayload, SignTypedDataPayload, GuardConfig, SendWalletTransactionPayload } from '../types/index.js';
...
export type PendingPayload = CreateNewSessionPayload | AddExplicitSessionPayload | ModifySessionPayload | SignMessagePayload | SignTypedDataPayload | SendWalletTransactionPayload;
