...
export declare const getRpcUrl: (chainId: Network.ChainId | bigint | number) => string;
export declare const getRelayerUrl: (chainId: Network.ChainId | bigint | number) => string;
