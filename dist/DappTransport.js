...
export class DappTransport {
    ...
    walletOrigin;
    constructor(walletUrl, mode = TransportMode.POPUP, popupModeOptions = {}, sequenceSessionStorage, redirectUrlActionHandler) {
    ...
    async sendRequest(action, payload, options = {}) {
        if (this.mode === TransportMode.REDIRECT) {
...
//# sourceMappingURL=DappTransport.js.map