import { commonjsGlobal as _, getDefaultExportFromCjs as V } from "../../../../../../_virtual/_commonjsHelpers.js";
import { __module as x } from "../../../../../../_virtual/browser-ponyfill.js";
(function(j, d) {
  var w = typeof globalThis < "u" && globalThis || typeof self < "u" && self || typeof _ < "u" && _, v = function() {
    function m() {
      this.fetch = !1, this.DOMException = w.DOMException;
    }
    return m.prototype = w, new m();
  }();
  (function(m) {
    (function(h) {
      var a = typeof m < "u" && m || typeof self < "u" && self || // eslint-disable-next-line no-undef
      typeof _ < "u" && _ || {}, u = {
      ...
      function I(e) {
        var t = new FileReader(), r = D(t), n = /charset=([A-Za-z0-9_-]+)/.exec(e.type), s = n ? n[1] : "utf-8";
      ...
      function l(e, t) {
        ...
        if (e instanceof l) {
          ...
          this.url = String(e);
        if (this.credentials = t.credentials || this.credentials || "same-origin", (t.headers || !this.headers) && (this.headers = new i(t.headers)), this.method = L(t.method || this.method || "GET"), this.mode = t.mode || this.mode || null, this.signal = t.signal || this.signal || function() {
...
`) === 0 ? n.substr(1, n.length) : n;
      ...
      R.call(c.prototype), c.prototype.clone = function() {
      ...
      }, h.DOMException = a.DOMException;
      try {
        new h.DOMException();
      } catch {
        h.DOMException = function(t, r) {
      ...
      function B(e, t) {
        return new Promise(function(r, n) {
          ...
          if (s.signal && s.signal.aborted)
            return n(new h.DOMException("Aborted", "AbortError"));
          ...
          o.onload = function() {
            ...
            s.url.indexOf("file://") === 0 && (o.status < 200 || o.status > 599) ? f.status = 200 : f.status = o.status, f.url = "responseURL" in o ? o.responseURL : f.headers.get("X-Request-URL");
            ...
            setTimeout(function() {
              n(new h.DOMException("Aborted", "AbortError"));
            }, 0);
          };
          function O(f) {
            try {
          ...
          if (o.open(s.method, O(s.url), !0), s.credentials === "include" ? o.withCredentials = !0 : s.credentials === "omit" && (o.withCredentials = !1), "responseType" in o && (u.blob ? o.responseType = "blob" : u.arrayBuffer && (o.responseType = "arraybuffer")), t && typeof t.headers == "object" && !(t.headers instanceof i || a.Headers && t.headers instanceof a.Headers)) {
            var U = [];
            Object.getOwnPropertyNames(t.headers).forEach(function(f) {
              U.push(b(f)), o.setRequestHeader(f, A(t.headers[f]));
            }), s.headers.forEach(function(f, y) {
              U.indexOf(y) === -1 && o.setRequestHeader(y, f);
            });
          } else
            s.headers.forEach(function(f, y) {
              o.setRequestHeader(y, f);
            });
          s.signal && (s.signal.addEventListener("abort", E), o.onreadystatechange = function() {
            o.readyState === 4 && s.signal.removeEventListener("abort", E);
          }), o.send(typeof s._bodyInit > "u" ? null : s._bodyInit);
        });
      }
      return B.polyfill = !0, a.fetch || (a.fetch = B, a.Headers = i, a.Request = l, a.Response = c), h.Headers = i, h.Request = l, h.Response = c, h.fetch = B, h;
    })({});
  })(v), v.fetch.ponyfill = !0, delete v.fetch.polyfill;
  var p = w.fetch ? w : v;
  d = p.fetch, d.default = p.fetch, d.fetch = p.fetch, d.Headers = p.Headers, d.Request = p.Request, d.Response = p.Response, j.exports = d;
})(x, x.exports);
var z = x.exports;
const J = /* @__PURE__ */ V(z);
export {
  J as default
};
