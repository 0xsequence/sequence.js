...
export class ChainSessionManager {
    ...
    async _loadSessionFromStorage(walletAddress) {
        ...
        if (implicitSession && implicitSession.chainId === this.chainId) {
            await this._initializeImplicitSessionInternal(implicitSession.pk, walletAddress, implicitSession.attestation, implicitSession.identitySignature, false, implicitSession.loginMethod, implicitSession.userEmail);
        }
