 ...
 */
export declare function encodeSessionCallSignatures(callSignatures: SessionCallSignature[], topology: SessionsTopology, identitySigner: Address.Address, explicitSigners?: Address.Address[], implicitSigners?: Address.Address[]): Bytes.Bytes;
