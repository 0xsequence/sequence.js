...
export type Payload = Calls | Message | ConfigUpdate | Digest | Recovery<Calls | Message | ConfigUpdate | Digest> | SessionImplicitAuthorize;
...
export declare function encodeSapient(chainId: bigint, payload: Parented): Exclude<AbiFunction.encodeData.Args<typeof RECOVER_SAPIENT_SIGNATURE>[0], undefined>[0];
export declare function hash(wallet: Address.Address, chainId: bigint, payload: Parented): Bytes.Bytes;
export declare function toTyped(wallet: Address.Address, chainId: bigint, payload: Parented): TypedDataToSign;
