...
export declare class DappClient {
     ...
     * });
     */
    connect(chainId: bigint, permissions?: Signers.Session.ExplicitParams, options?: {
     ...
     * }
     */
    addExplicitSession(chainId: bigint, permissions: Signers.Session.ExplicitParams): Promise<void>;
    /**
     ...
     * }
     */
    modifyExplicitSession(chainId: bigint, sessionAddress: Address.Address, permissions: Signers.Session.ExplicitParams): Promise<void>;
    /**
     ...
     * }
     */
    getFeeOptions(chainId: bigint, transactions: Transaction[]): Promise<Relayer.FeeOption[]>;
    /**
     ...
     */
    sendTransaction(chainId: bigint, transactions: Transaction[], feeOption?: Relayer.FeeOption): Promise<Hex.Hex>;
    /**
     ...
     * }
     */
    signMessage(chainId: bigint, message: string): Promise<void>;
    /**
     ...
     * }
     */
    signTypedData(chainId: bigint, typedData: TypedData): Promise<void>;
    /**
