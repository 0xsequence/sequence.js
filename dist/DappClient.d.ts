...
import { DappClientExplicitSessionEventListener, DappClientSignatureEventListener, RandomPrivateKeyFn, SequenceSessionStorage, Session, Transaction, TransportMode } from './types/index.js';
...
export declare class DappClient {
    ...
    private redirectUrlActionHandler?;
     ...
     */
    constructor(walletUrl: string, options?: {
     ...
     * });
     */
    connect(chainId: ChainId, implicitSessionRedirectUrl: string, permissions?: Signers.Session.ExplicitParams, options?: {
     ...
     * }
     */
    addExplicitSession(chainId: ChainId, permissions: Signers.Session.ExplicitParams): Promise<void>;
    /**
     ...
     * }
     */
    modifyExplicitSession(chainId: ChainId, sessionAddress: Address.Address, permissions: Signers.Session.ExplicitParams): Promise<void>;
    /**
     ...
     * }
     */
    getFeeOptions(chainId: ChainId, transactions: Transaction[]): Promise<Relayer.FeeOption[]>;
    /**
     ...
     */
    sendTransaction(chainId: ChainId, transactions: Transaction[], feeOption?: Relayer.FeeOption): Promise<string>;
    /**
     ...
     * }
     */
    signMessage(chainId: ChainId, message: string): Promise<void>;
    /**
     ...
     * }
     */
    signTypedData(chainId: ChainId, typedData: TypedData): Promise<void>;
    /**
