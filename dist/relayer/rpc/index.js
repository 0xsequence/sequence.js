import { Relayer as GenRelayer, FeeTokenType, } from './relayer.gen.js';
import { Address, Hex, Bytes, AbiFunction } from 'ox';
import { Payload } from '@0xsequence/wallet-primitives';
import { ETHTxnStatus, } from './relayer.gen.js';
...
export const getChain = (chainId) => {
    const chain = Object.values(chains).find((c) => typeof c === 'object' && 'id' in c && c.id === chainId);
    if (!chain) {
...
export class RpcRelayer {
    ...
    fetch;
    provider;
    constructor(hostname, chainId, rpcUrl, fetchImpl) {
    ...
    mapRpcFeeOptionToFeeOption(rpcOption) {
        return {
