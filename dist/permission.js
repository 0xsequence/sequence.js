...
export function encodeSessionPermissions(sessionPermissions) {
    ...
    return Bytes.concat(Bytes.padLeft(Bytes.fromHex(sessionPermissions.signer), 20), Bytes.padLeft(Bytes.fromNumber(sessionPermissions.valueLimit), 32), Bytes.padLeft(Bytes.fromNumber(sessionPermissions.deadline, { size: 8 }), 8), Bytes.fromNumber(sessionPermissions.permissions.length, { size: 1 }), Bytes.concat(...encodedPermissions));
}
