import { Constants, Extensions, Permission, SessionConfig, SessionSignature, } from '@0xsequence/wallet-primitives';
...
export class Explicit {
    ...
    async signCall(wallet, chainId, payload, callIdx, sessionManagerAddress, provider) {
        ...
        // Sign it
        const useDeprecatedHash = Address.isEqual(sessionManagerAddress, Extensions.Dev1.sessions) ||
