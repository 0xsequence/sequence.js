...
export declare class Explicit implements ExplicitSessionSigner {
    ...
    findSupportedPermission(wallet: Address.Address, _chainId: bigint, call: Payload.Call, sessionManagerAddress: Address.Address, provider?: Provider.Provider): Promise<Permission.Permission | undefined>;
