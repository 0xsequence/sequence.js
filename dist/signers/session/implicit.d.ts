...
export declare class Implicit implements SessionSigner {
    ...
    supportedCall(wallet: Address.Address, _chainId: bigint, call: Payload.Call, _sessionManagerAddress: Address.Address, provider?: Provider.Provider): Promise<boolean>;
