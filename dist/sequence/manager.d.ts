...
export declare const ManagerOptionsDefaults: {
    ...
    networks: Network.Network[];
    relayers: () => Relayer.Standard.LocalRelayer[];
    bundlers: never[];
    guardUrl: string;
    guardAddresses: Record<GuardRole, Address.Address>;
    defaultGuardTopology: Config.SignerLeaf;
...
export declare function applyManagerOptionsDefaults(options?: ManagerOptions): {
    ...
    stateProvider: State.Provider;
    networks: Network.Network[];
    relayers: (() => Relayer.Standard.LocalRelayer[]) | Relayer.Relayer[] | (() => Relayer.Relayer[]);
    bundlers: Relayer.Bundler[];
    guardUrl: string;
    guardAddresses: Record<GuardRole, Address.Address>;
    defaultGuardTopology: Config.SignerLeaf;
...
export declare class Manager {
    ...
    registerGuardUI(onPromptOtp: (codeType: 'TOTP' | 'PIN', respond: (otp: string) => Promise<void>) => Promise<void>): () => void;
