...
export interface SessionsInterface {
     ...
     * @see {complete} to finalize the update after it has been signed.
     */
    modifyExplicitSession(walletAddress: Address.Address, sessionAddress: Address.Address, permissions: CoreSigners.Session.ExplicitParams, origin?: string): Promise<string>;
    /**
