...
export declare class LocalRelayer implements Relayer {
    ...
    private decodeCalls;
    relay(to: Address.Address, data: Hex.Hex, chainId: number, quote?: FeeQuote, preconditions?: IntentPrecondition[], checkInterval?: number): Promise<{
        opHash: Hex.Hex;
    }>;
...
export declare class EIP1193ProviderAdapter implements GenericProvider {
    ...
    getTransactionReceipt(txHash: Hex.Hex, chainId: number): Promise<"unknown" | "failed" | "success">;
}
export {};
