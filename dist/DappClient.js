...
export class DappClient {
    ...
    getChainSessionManager(chainId) {
        ...
        if (!chainSessionManager) {
            chainSessionManager = new ChainSessionManager(chainId, this.transport, this.projectAccessKey, this.keymachineUrl, this.nodesUrl, this.relayerUrl, this.sequenceStorage, this.origin + (this.redirectPath ? this.redirectPath : ''), this.randomPrivateKeyFn, this.canUseIndexedDb);
