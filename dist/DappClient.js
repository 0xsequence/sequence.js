...
export class DappClient {
     ...
     */
    constructor(walletUrl, origin, options) {
        const { transportMode = TransportMode.POPUP, keymachineUrl = DEFAULT_KEYMACHINE_URL, redirectPath, sequenceStorage = new WebStorage(), sequenceSessionStorage, randomPrivateKeyFn, redirectActionHandler, canUseIndexedDb = true, } = options || {};
     ...
     * });
     */
    async connect(chainId, permissions, options = {}) {
    ...
    getChainSessionManager(chainId) {
        ...
        if (!chainSessionManager) {
            chainSessionManager = new ChainSessionManager(chainId, this.keymachineUrl, this.transport, this.sequenceStorage, this.origin + (this.redirectPath ? this.redirectPath : ''), this.randomPrivateKeyFn, this.canUseIndexedDb);
