...
export class DappClient {
    ...
    async getFeeTokens(chainId) {
        const relayer = new Relayer.Standard.Rpc.RpcRelayer(getRelayerUrl(chainId, this.relayerUrl), chainId, getRpcUrl(chainId, this.nodesUrl, this.projectAccessKey));
