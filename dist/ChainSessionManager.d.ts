...
import { ExplicitSessionEventListener, LoginMethod, RandomPrivateKeyFn, Session, SignatureEventListener, Transaction } from './types/index.js';
...
export declare class ChainSessionManager {
     ...
     */
    constructor(chainId: number, transport: DappTransport, projectAccessKey: string, keyMachineUrl: string, nodesUrl: string, relayerUrl: string, sequenceStorage: SequenceStorage, redirectUrl: string, randomPrivateKeyFn?: RandomPrivateKeyFn, canUseIndexedDb?: boolean);
    /**
