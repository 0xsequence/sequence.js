...
export declare class ChainSessionManager {
     ...
     */
    constructor(chainId: bigint, keyMachineUrl: string, transport: DappTransport, sequenceStorage: SequenceStorage, redirectUrl: string, randomPrivateKeyFn?: RandomPrivateKeyFn, canUseIndexedDb?: boolean);
    /**
