/* eslint-disable */
// sequence-api v0.4.0 6c7b4201420c7baedfbf84f76b211768905c3616
// --
...
export const WebRPCSchemaHash = '6c7b4201420c7baedfbf84f76b211768905c3616'
...
export interface API {
  ...
  getSardineNFTCheckoutToken(headers?: object): Promise<GetSardineNFTCheckoutTokenReturn>
...
export class API implements API {
  ...
  getSardineNFTCheckoutToken = (headers?: object): Promise<GetSardineNFTCheckoutTokenReturn> => {
    return this.fetch(this.url('GetSardineNFTCheckoutToken'), createHTTPRequest({}, headers)).then(res => {
      return buildResponse(res).then(_data => {
        return {
          token: <string>_data.token
        }
