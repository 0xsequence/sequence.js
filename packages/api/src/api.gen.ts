...
export const WebRPCSchemaHash = 'c420a4f1777b406e7de6c3130329b15602e179e2'
...
export interface Lootbox {
  ...
  projectId: number
  contractAddress: string
  contentBytes: Array<string>
  content: Array<LootboxContent>
  createdAt?: string
}
...
export interface API {
  ...
  saveLootbox(args: SaveLootboxArgs, headers?: object, signal?: AbortSignal): Promise<SaveLootboxReturn>
  getLootbox(args: GetLootboxArgs, headers?: object, signal?: AbortSignal): Promise<GetLootboxReturn>
  deleteLootbox(args: DeleteLootboxArgs, headers?: object, signal?: AbortSignal): Promise<DeleteLootboxReturn>
  updateLootboxContent(
    args: UpdateLootboxContentArgs,
    headers?: object,
    signal?: AbortSignal
  ): Promise<UpdateLootboxContentReturn>
}
...
export interface SaveLootboxArgs {
  lootbox: Lootbox
}

export interface SaveLootboxReturn {
  merkleRoot: string
}
export interface GetLootboxArgs {
  contractAddress: string
  chainId: number
}

export interface GetLootboxReturn {
  lootbox: Lootbox
}
export interface DeleteLootboxArgs {
  contractAddress: string
  chainId: number
}

export interface DeleteLootboxReturn {
  status: boolean
}
export interface UpdateLootboxContentArgs {
  lootbox: Lootbox
}

export interface UpdateLootboxContentReturn {
  merkleRoot: string
}
...
export class API implements API {
  ...
  saveLootbox = (args: SaveLootboxArgs, headers?: object, signal?: AbortSignal): Promise<SaveLootboxReturn> => {
    return this.fetch(this.url('SaveLootbox'), createHTTPRequest(args, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {
  ...
  getLootbox = (args: GetLootboxArgs, headers?: object, signal?: AbortSignal): Promise<GetLootboxReturn> => {
    return this.fetch(this.url('GetLootbox'), createHTTPRequest(args, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {
            lootbox: <Lootbox>_data.lootbox
          }
        })
      },
      error => {
  ...
  deleteLootbox = (args: DeleteLootboxArgs, headers?: object, signal?: AbortSignal): Promise<DeleteLootboxReturn> => {
    return this.fetch(this.url('DeleteLootbox'), createHTTPRequest(args, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {
            status: <boolean>_data.status
  ...
  updateLootboxContent = (
    ...
    return this.fetch(this.url('UpdateLootboxContent'), createHTTPRequest(args, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {
            merkleRoot: <string>_data.merkleRoot
