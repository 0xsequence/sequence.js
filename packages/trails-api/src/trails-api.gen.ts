...
export const WebrpcSchemaHash = '563242406b1457bb583d99d0c76c9e75e3f3b3f3'
...
export interface IntentConfig {
  ...
  originMetaTxnId?: string
  destinationMetaTxnId?: string
...
export class API implements APIClient {
  ...
  queryKey = {
    ...
    executeIntent: (req: ExecuteIntentRequest) => ['API', 'executeIntent', req] as const,
    getIntentCallsPayloads: (req: GetIntentCallsPayloadsRequest) => ['API', 'getIntentCallsPayloads', req] as const,
    getIntentsQuote: (req: GetIntentsQuoteRequest) => ['API', 'getIntentsQuote', req] as const,
    ...
    getIntentTransactionHistory: (req: GetIntentTransactionHistoryRequest) =>
      ['API', 'getIntentTransactionHistory', req] as const,
    getIntentEntrypointDeposit: (req: GetIntentEntrypointDepositRequest) => ['API', 'getIntentEntrypointDeposit', req] as const,
    getIntentEntrypointDepositFeeOptions: (req: GetIntentEntrypointDepositFeeOptionsRequest) =>
      ['API', 'getIntentEntrypointDepositFeeOptions', req] as const,
    getIntentEntrypointMessageHash: (req: GetIntentEntrypointMessageHashRequest) =>
      ['API', 'getIntentEntrypointMessageHash', req] as const,
  ...
  getIntentsQuote = (req: GetIntentsQuoteRequest, headers?: object, signal?: AbortSignal): Promise<GetIntentsQuoteResponse> => {
    return this.fetch(
      this.url('GetIntentsQuote'),
      createHttpRequest(JsonEncode(req, 'GetIntentsQuoteRequest'), headers, signal)
    ).then(
      res => {
        return buildResponse(res).then(_data => {
          return JsonDecode<GetIntentsQuoteResponse>(_data, 'GetIntentsQuoteResponse')
        })
      },
      error => {
        throw WebrpcRequestFailedError.new({ cause: `fetch(): ${error instanceof Error ? error.message : String(error)}` })
  ...
  getIntentEntrypointDeposit = (
    ...
    return this.fetch(
      this.url('GetIntentEntrypointDeposit'),
      createHttpRequest(JsonEncode(req, 'GetIntentEntrypointDepositRequest'), headers, signal)
    ).then(
      res => {
        return buildResponse(res).then(_data => {
          return JsonDecode<GetIntentEntrypointDepositResponse>(_data, 'GetIntentEntrypointDepositResponse')
        })
      },
      error => {
        throw WebrpcRequestFailedError.new({ cause: `fetch(): ${error instanceof Error ? error.message : String(error)}` })
  ...
  getIntentEntrypointDepositFeeOptions = (
    ...
    return this.fetch(
      this.url('GetIntentEntrypointDepositFeeOptions'),
      createHttpRequest(JsonEncode(req, 'GetIntentEntrypointDepositFeeOptionsRequest'), headers, signal)
    ).then(
      res => {
        return buildResponse(res).then(_data => {
          return JsonDecode<GetIntentEntrypointDepositFeeOptionsResponse>(_data, 'GetIntentEntrypointDepositFeeOptionsResponse')
        })
      },
      error => {
        throw WebrpcRequestFailedError.new({ cause: `fetch(): ${error instanceof Error ? error.message : String(error)}` })
  ...
  getIntentEntrypointMessageHash = (
    ...
    return this.fetch(
      this.url('GetIntentEntrypointMessageHash'),
      createHttpRequest(JsonEncode(req, 'GetIntentEntrypointMessageHashRequest'), headers, signal)
    ).then(
      res => {
        return buildResponse(res).then(_data => {
          return JsonDecode<GetIntentEntrypointMessageHashResponse>(_data, 'GetIntentEntrypointMessageHashResponse')
        })
      },
      error => {
        throw WebrpcRequestFailedError.new({ cause: `fetch(): ${error instanceof Error ? error.message : String(error)}` })
...
export const WebrpcHeaderValue = 'webrpc@v0.30.1;gen-typescript@v0.22.0;trails-api@v0.4.0'
