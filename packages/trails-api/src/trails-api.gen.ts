...
export const WebrpcSchemaVersion = 'v1-25.11.14+9db63bbe'

// Schema hash generated from your RIDL schema
export const WebrpcSchemaHash = '907e9a4690aa7181864692baa21f0728a832801d'
...
export class IntentsSameChainNativeError extends WebrpcError {
  constructor(error: WebrpcErrorParams = {}) {
    super(error)
    this.name = error.name || 'IntentsSameChainNative'
    this.code = typeof error.code === 'number' ? error.code : 7000
    this.message = error.message || `Intents skipped as client is attempting same-chain native transaction`
    this.status = typeof error.status === 'number' ? error.status : 400
    if (error.cause !== undefined) this.cause = error.cause
    Object.setPrototypeOf(this, IntentsSameChainNativeError.prototype)
  }
}
...
export enum errors {
  ...
  IntentsSameChainNative = 'IntentsSameChainNative',
...
export const webrpcErrorByCode: { [code: number]: any } = {
  ...
  [7000]: IntentsSameChainNativeError,
...
export const WebrpcHeaderValue = 'webrpc@v0.31.2;gen-typescript@v0.23.1;trails-api@v1-25.11.14+9db63bbe'
