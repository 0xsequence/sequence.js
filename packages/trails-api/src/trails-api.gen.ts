...
export interface API {
   ...
   */
  executeIntent(args: ExecuteIntentArgs, headers?: object, signal?: AbortSignal): Promise<ExecuteIntentReturn>
  /**
  ...
  getIntentEntrypointDeposit(
    args: GetIntentEntrypointDepositArgs,
    headers?: object,
    signal?: AbortSignal
  ): Promise<GetIntentEntrypointDepositReturn>
  /**
   * Calculates fee options for intent entrypoint deposits.
   */
  getIntentEntrypointDepositFeeOptions(
    args: GetIntentEntrypointDepositFeeOptionsArgs,
    headers?: object,
    signal?: AbortSignal
  ): Promise<GetIntentEntrypointDepositFeeOptionsReturn>
  /**
   * Calculates the EIP-712 message hash that user needs to sign for intent entrypoint deposit.
   */
  getIntentEntrypointMessageHash(
    args: GetIntentEntrypointMessageHashArgs,
    headers?: object,
    signal?: AbortSignal
  ): Promise<GetIntentEntrypointMessageHashReturn>
...
export interface ExecuteIntentReturn {
  config: IntentConfig
}
...
export interface GetIntentEntrypointDepositArgs {
  params: GetIntentEntrypointDepositParams
}

export interface GetIntentEntrypointDepositReturn {
  result: GetIntentEntrypointDepositResult
}
export interface GetIntentEntrypointDepositFeeOptionsArgs {
  params: GetIntentEntrypointDepositFeeOptionsParams
}

export interface GetIntentEntrypointDepositFeeOptionsReturn {
  result: GetIntentEntrypointDepositFeeOptionsResult
}
export interface GetIntentEntrypointMessageHashArgs {
  params: GetIntentEntrypointMessageHashParams
}

export interface GetIntentEntrypointMessageHashReturn {
  messageHash: string
}
...
export class API implements API {
  ...
  executeIntent = (args: ExecuteIntentArgs, headers?: object, signal?: AbortSignal): Promise<ExecuteIntentReturn> => {
    return this.fetch(this.url('ExecuteIntent'), createHTTPRequest(args, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {
  ...
  getIntentEntrypointDeposit = (
    ...
    return this.fetch(this.url('GetIntentEntrypointDeposit'), createHTTPRequest(args, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {
  ...
  getIntentEntrypointDepositFeeOptions = (
    ...
    return this.fetch(this.url('GetIntentEntrypointDepositFeeOptions'), createHTTPRequest(args, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {
  ...
  getIntentEntrypointMessageHash = (
    ...
    return this.fetch(this.url('GetIntentEntrypointMessageHash'), createHTTPRequest(args, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {
