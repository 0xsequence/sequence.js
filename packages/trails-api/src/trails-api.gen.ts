...
export const WebrpcSchemaHash = 'd77c84a0d98b34c7e6d3a9810cc8819aee40b978'
...
const BIG_INT_FIELDS: { [typ: string]: (string | [string, string])[] } = {
  ...
  IntentTransactionGasFee: ['totalGasLimit', 'gasPrice', 'totalFeeAmount', ['metaTxnFeeDetails', 'MetaTxnFeeDetail[]']],
  MetaTxnFeeDetail: ['estimatedGasLimit', 'feeNative'],
