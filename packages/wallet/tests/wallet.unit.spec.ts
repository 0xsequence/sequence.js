...
import { getBytes, keccak256, randomBytes, toUtf8Bytes, Wallet, ZeroAddress } from 'ethers'
  ...
  describe('signing', () => {
    it('Should sign a nested message', async () => {
      const context = {
        ...
        mainModuleUpgradable: ZeroAddress,
        nonStrict: true
      }

      const signer = new Wallet('0x2bf2dfccb8c9fb4bb4d46ac9e2b537c373b44ae4c2ee66de92e02f132f7c2237')
      ...
      const message =
        '0xa5c192879af3d12649fddbc1923aec506ac2a2697421ca198f2443efca1e17cd46e1090945dd946f32c0f957a013a564c8006e1e756534b4d8821bba94731b98a2c00daf2e5d69275fdbf4753b912878f2abd37fbb4de896d11147c8e7a3f8'

      const signed = await wallet.signMessage(message, 31337, true)
      expect(signed).to.equal(
        '0x00010201cbf920895f0a101b85f94903775e61d1b652b6ca004700010001bb1be304f3e34bca7ce59067d47f70cddf41c6888166a924570319b6d0e1606e37d92b1ad79895d7e78e8e621a3ecadc884a6cbca4fff1b3e130c7313c1772591c0203'
      )
    })
    it('Should sign a message', async () => {
      ...
      const expected =
        '0x00010001a0fb306480bc3027c04d33a16370f4618b29f2d5b89464f526045c94802bc9d1525389c364b75daf58e859ed0d6105aac6b3718e4659814c7793c626653edb871b02'
    ...
    it('Should sign and recover the configuration of a single signer', async () => {
      ...
      const digest = packMessageData(wallet.address, chainId, keccak256(message))
