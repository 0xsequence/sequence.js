...
export const Dev1: Context = {
  factory: normalize('0xe828630697817291140D6B7A42a2c3b7277bE45a'),
  stage1: normalize('0x2a4fB19F66F1427A5E363Bf1bB3be27b9A9ACC39'),
  stage2: normalize('0xe1299E4456b267123F7Aba29B72C2164ff501BDa'),
...
export const Dev2: Context = {
  factory: normalize('0xFE14B91dE3c5Ca74c4D24608EBcD4B2848aA6010'),
  stage1: normalize('0x300E98ae5bEA4A7291d62Eb0b9feD535E10095dD'),
  stage2: normalize('0x90cb0a8ccf40bEdA60896e408bdc7801033447C6'),
...
export const Dev2_4337: Context = {
  factory: normalize('0xFE14B91dE3c5Ca74c4D24608EBcD4B2848aA6010'),
  stage1: normalize('0x8Ae58FCc0Ee9b32994CA52c9854deb969DC8fa2A'),
  stage2: normalize('0x30f8e3AceAcDEac8a3F28935D87FD58DC5f71ad2'),
  creationCode: '0x6041600e3d396021805130553df33d3d36153402601f57363d3d373d363d30545af43d82803e903d91601f57fd5bf3',
  capabilities: {
    erc4337: {
      entrypoint: normalize('0x0000000071727De22E5E9d8BAf0edAc6f37da032'),
    },
  },
}
