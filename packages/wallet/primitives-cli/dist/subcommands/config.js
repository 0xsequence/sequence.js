...
const configCommand = {
    ...
    builder: (yargs) => {
        return yargs
            .command('new [content...]', 'Create a new configuration', (yargs) => {
            return yargs
                .option('threshold', {
                type: 'string',
            ...
            .command('image-hash [input]', 'Calculate image hash from hex input', (yargs) => {
            ...
            .command('encode [input]', 'Encode configuration from hex input', (yargs) => {
            return yargs.positional('input', {
                type: 'string',
