...
//   },
// ]
export async function doEncode(input, signatures = [], noChainId, checkpointerData) {
...
export async function doConcat(signatures) {
...
export async function doDecode(signature) {
...
const signatureCommand = {
    ...
    builder: (yargs) => {
        return yargs
            .command('encode [input]', 'Encode signature from hex input', (yargs) => {
            return yargs
                .option('signature', {
                type: 'string',
                array: true,
            ...
            .command('concat [signatures...]', 'Concatenate multiple signatures', (yargs) => {
            ...
            .command('decode [signature]', 'Decode a signature from bytes', (yargs) => {
