...
export async function doAddSession(sessionInput, topologyInput) {
...
export async function doRemoveSession(explicitSessionAddress, topologyInput) {
...
const sessionExplicitCommand = {
    command: 'explicit',
    describe: 'Explicit session utilities',
    builder: (yargs) => {
        return yargs
            .command('add [explicit-session] [session-topology]', 'Add a session to the session topology', (yargs) => {
            return yargs
            ...
            .command('remove [explicit-session-address] [session-topology]', 'Remove a session from the session topology', (yargs) => {
            return yargs
...
//# sourceMappingURL=sessionExplicit.js.map