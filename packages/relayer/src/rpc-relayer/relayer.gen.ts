...
export class Relayer implements RelayerClient {
  ...
  sendMetaTxn = (req: SendMetaTxnArgs, headers?: object, signal?: AbortSignal): Promise<SendMetaTxnReturn> => {
    return this.fetch(this.url('SendMetaTxn'), createHttpRequest(req, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {
            status: <boolean>_data.status,
  ...
  getMetaTxnNonce = (req: GetMetaTxnNonceArgs, headers?: object, signal?: AbortSignal): Promise<GetMetaTxnNonceReturn> => {
    return this.fetch(this.url('GetMetaTxnNonce'), createHttpRequest(req, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {
  ...
  getMetaTxnReceipt = (req: GetMetaTxnReceiptArgs, headers?: object, signal?: AbortSignal): Promise<GetMetaTxnReceiptReturn> => {
    return this.fetch(this.url('GetMetaTxnReceipt'), createHttpRequest(req, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {
  ...
  simulate = (req: SimulateArgs, headers?: object, signal?: AbortSignal): Promise<SimulateReturn> => {
    return this.fetch(this.url('Simulate'), createHttpRequest(req, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {
  ...
  simulateV3 = (req: SimulateV3Args, headers?: object, signal?: AbortSignal): Promise<SimulateV3Return> => {
    return this.fetch(this.url('SimulateV3'), createHttpRequest(req, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {
  ...
  updateMetaTxnGasLimits = (
    ...
    return this.fetch(this.url('UpdateMetaTxnGasLimits'), createHttpRequest(req, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {
  ...
  feeOptions = (req: FeeOptionsArgs, headers?: object, signal?: AbortSignal): Promise<FeeOptionsReturn> => {
    return this.fetch(this.url('FeeOptions'), createHttpRequest(req, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {
  ...
  getMetaTxnNetworkFeeOptions = (
    ...
    return this.fetch(this.url('GetMetaTxnNetworkFeeOptions'), createHttpRequest(req, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {
            options: <Array<FeeOption>>_data.options
  ...
  getMetaTransactions = (
    ...
    return this.fetch(this.url('GetMetaTransactions'), createHttpRequest(req, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {
  ...
  getTransactionCost = (
    ...
    return this.fetch(this.url('GetTransactionCost'), createHttpRequest(req, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {
  ...
  sentTransactions = (req: SentTransactionsArgs, headers?: object, signal?: AbortSignal): Promise<SentTransactionsReturn> => {
    return this.fetch(this.url('SentTransactions'), createHttpRequest(req, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {
            page: <Page>_data.page,
  ...
  pendingTransactions = (
    ...
    return this.fetch(this.url('PendingTransactions'), createHttpRequest(req, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {
            page: <Page>_data.page,
  ...
  getGasTank = (req: GetGasTankArgs, headers?: object, signal?: AbortSignal): Promise<GetGasTankReturn> => {
    return this.fetch(this.url('GetGasTank'), createHttpRequest(req, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {
  ...
  addGasTank = (req: AddGasTankArgs, headers?: object, signal?: AbortSignal): Promise<AddGasTankReturn> => {
    return this.fetch(this.url('AddGasTank'), createHttpRequest(req, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {
            status: <boolean>_data.status,
  ...
  updateGasTank = (req: UpdateGasTankArgs, headers?: object, signal?: AbortSignal): Promise<UpdateGasTankReturn> => {
    return this.fetch(this.url('UpdateGasTank'), createHttpRequest(req, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {
            status: <boolean>_data.status,
  ...
  nextGasTankBalanceAdjustmentNonce = (
    ...
    return this.fetch(this.url('NextGasTankBalanceAdjustmentNonce'), createHttpRequest(req, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {
  ...
  adjustGasTankBalance = (
    ...
    return this.fetch(this.url('AdjustGasTankBalance'), createHttpRequest(req, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {
            status: <boolean>_data.status,
  ...
  getGasTankBalanceAdjustment = (
    ...
    return this.fetch(this.url('GetGasTankBalanceAdjustment'), createHttpRequest(req, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {
            adjustment: <GasTankBalanceAdjustment>_data.adjustment
  ...
  listGasTankBalanceAdjustments = (
    ...
    return this.fetch(this.url('ListGasTankBalanceAdjustments'), createHttpRequest(req, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {
            page: <Page>_data.page,
  ...
  listGasSponsors = (req: ListGasSponsorsArgs, headers?: object, signal?: AbortSignal): Promise<ListGasSponsorsReturn> => {
    return this.fetch(this.url('ListGasSponsors'), createHttpRequest(req, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {
            page: <Page>_data.page,
  ...
  getGasSponsor = (req: GetGasSponsorArgs, headers?: object, signal?: AbortSignal): Promise<GetGasSponsorReturn> => {
    return this.fetch(this.url('GetGasSponsor'), createHttpRequest(req, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {
  ...
  addGasSponsor = (req: AddGasSponsorArgs, headers?: object, signal?: AbortSignal): Promise<AddGasSponsorReturn> => {
    return this.fetch(this.url('AddGasSponsor'), createHttpRequest(req, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {
            status: <boolean>_data.status,
  ...
  updateGasSponsor = (req: UpdateGasSponsorArgs, headers?: object, signal?: AbortSignal): Promise<UpdateGasSponsorReturn> => {
    return this.fetch(this.url('UpdateGasSponsor'), createHttpRequest(req, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {
            status: <boolean>_data.status,
  ...
  removeGasSponsor = (req: RemoveGasSponsorArgs, headers?: object, signal?: AbortSignal): Promise<RemoveGasSponsorReturn> => {
    return this.fetch(this.url('RemoveGasSponsor'), createHttpRequest(req, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {
            status: <boolean>_data.status
  ...
  addressGasSponsors = (
    ...
    return this.fetch(this.url('AddressGasSponsors'), createHttpRequest(req, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {
            page: <Page>_data.page,
  ...
  getProjectBalance = (req: GetProjectBalanceArgs, headers?: object, signal?: AbortSignal): Promise<GetProjectBalanceReturn> => {
    return this.fetch(this.url('GetProjectBalance'), createHttpRequest(req, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {
  ...
  adjustProjectBalance = (
    ...
    return this.fetch(this.url('AdjustProjectBalance'), createHttpRequest(req, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {
            balance: <number>_data.balance
...
export const WebrpcHeaderValue = 'webrpc@v0.29.0;gen-typescript@v0.20.2;sequence-relayer@v0.4.1'
