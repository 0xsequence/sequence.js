...
export const WebRPCSchemaHash = 'fa97054e223493177aebecd1739a101f077728de'
...
export class Bundler implements Bundler {
  ...
  status = (headers?: object, signal?: AbortSignal): Promise<StatusReturn> => {
    return this.fetch(this.url('Status'), createHTTPRequest({}, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {
  ...
  peers = (headers?: object, signal?: AbortSignal): Promise<PeersReturn> => {
    return this.fetch(this.url('Peers'), createHTTPRequest({}, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {
  ...
  mempool = (headers?: object, signal?: AbortSignal): Promise<MempoolReturn> => {
    return this.fetch(this.url('Mempool'), createHTTPRequest({}, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {
  ...
  sendOperation = (args: SendOperationArgs, headers?: object, signal?: AbortSignal): Promise<SendOperationReturn> => {
    return this.fetch(this.url('SendOperation'), createHTTPRequest(args, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {
  ...
  operations = (headers?: object, signal?: AbortSignal): Promise<OperationsReturn> => {
    return this.fetch(this.url('Operations'), createHTTPRequest({}, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {
  ...
  feeAsks = (headers?: object, signal?: AbortSignal): Promise<FeeAsksReturn> => {
    return this.fetch(this.url('FeeAsks'), createHTTPRequest({}, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {
...
export class Debug implements Debug {
  ...
  broadcast = (args: BroadcastArgs, headers?: object, signal?: AbortSignal): Promise<BroadcastReturn> => {
    return this.fetch(this.url('Broadcast'), createHTTPRequest(args, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {
            status: <boolean>_data.status
...
export class Admin implements Admin {
  ...
  reserveOperations = (args: ReserveOperationsArgs, headers?: object, signal?: AbortSignal): Promise<ReserveOperationsReturn> => {
    return this.fetch(this.url('ReserveOperations'), createHTTPRequest(args, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {
  ...
  releaseOperations = (args: ReleaseOperationsArgs, headers?: object, signal?: AbortSignal): Promise<ReleaseOperationsReturn> => {
    return this.fetch(this.url('ReleaseOperations'), createHTTPRequest(args, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {}
        })
  ...
  discardOperations = (args: DiscardOperationsArgs, headers?: object, signal?: AbortSignal): Promise<DiscardOperationsReturn> => {
    return this.fetch(this.url('DiscardOperations'), createHTTPRequest(args, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {}
        })
  ...
  banEndorser = (args: BanEndorserArgs, headers?: object, signal?: AbortSignal): Promise<BanEndorserReturn> => {
    return this.fetch(this.url('BanEndorser'), createHTTPRequest(args, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {}
        })
  ...
  bannedEndorsers = (headers?: object, signal?: AbortSignal): Promise<BannedEndorsersReturn> => {
    return this.fetch(this.url('BannedEndorsers'), createHTTPRequest({}, headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
          return {
...
export class NotFoundError extends WebrpcError {
  constructor(name: string = 'NotFound', code: number = 1000, message: string = 'Not found', status: number = 0, cause?: string) {
    super(name, code, message, status, cause)
