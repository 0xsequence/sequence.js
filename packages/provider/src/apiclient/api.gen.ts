/* tslint:disable */
// arcadeum-api v0.3.0 77f64c1ded23fe74a28ce3454b5c01c78882b8df
// --
...
export const WebRPCSchemaHash = "77f64c1ded23fe74a28ce3454b5c01c78882b8df"
...
export interface Transaction {
  ...
  tokenMetadata?: {[key: string]: {[key: number]: TokenMetadata}}
  timestamp: string
}
...
export interface ArcadeumAPI {
  ...
  getNiftyswapTotalSupply(args: GetNiftyswapTotalSupplyArgs, headers?: object): Promise<GetNiftyswapTotalSupplyReturn>
...
export interface GetNiftyswapTotalSupplyArgs {
  shopContractHandle: string
  ids: Array<number>
}

export interface GetNiftyswapTotalSupplyReturn {
  amounts: Array<string>  
}
...
export class ArcadeumAPI implements ArcadeumAPI {
  ...
  decodeTxnData = (args: DecodeTxnDataArgs, headers?: object): Promise<DecodeTxnDataReturn> => {
    return this.fetch(
      ...
      return buildResponse(res).then(_data => {
        return {
          methodName: <string>(_data.methodName), 
          args: <{[key: string]: any}>(_data.args)
        }
      })
    })
  }
  ...
  getNiftyswapTotalSupply = (args: GetNiftyswapTotalSupplyArgs, headers?: object): Promise<GetNiftyswapTotalSupplyReturn> => {
    return this.fetch(
      this.url('GetNiftyswapTotalSupply'),
      createHTTPRequest(args, headers)).then((res) => {
      return buildResponse(res).then(_data => {
        return {
