...
export class Indexer implements IndexerClient {
  ...
  addWebhookListener = (
    ...
    return this.fetch(
      ...
      createHttpRequest(JsonEncode(req, 'AddWebhookListenerRequest'), headers, signal)
    ).then(
      res => {
  ...
  fetchTransactionReceipt = (
    ...
    return this.fetch(
      ...
      createHttpRequest(JsonEncode(req, 'FetchTransactionReceiptRequest'), headers, signal)
    ).then(
      res => {
        return buildResponse(res).then(_data => {
  ...
  fetchTransactionReceiptWithFilter = (
    ...
    return this.fetch(
      ...
      createHttpRequest(JsonEncode(req, 'FetchTransactionReceiptWithFilterRequest'), headers, signal)
    ).then(
      res => {
        return buildResponse(res).then(_data => {
  ...
  getAllWebhookListeners = (
    ...
    return this.fetch(
      ...
      createHttpRequest(JsonEncode(req, 'GetAllWebhookListenersRequest'), headers, signal)
    ).then(
      res => {
        return buildResponse(res).then(_data => {
  ...
  getBalanceUpdates = (
    ...
    return this.fetch(
      ...
      createHttpRequest(JsonEncode(req, 'GetBalanceUpdatesRequest'), headers, signal)
    ).then(
      res => {
        return buildResponse(res).then(_data => {
  ...
  getEtherBalance = (req: GetEtherBalanceRequest, headers?: object, signal?: AbortSignal): Promise<GetEtherBalanceResponse> => {
    return this.fetch(
      ...
      createHttpRequest(JsonEncode(req, 'GetEtherBalanceRequest'), headers, signal)
    ).then(
      res => {
        return buildResponse(res).then(_data => {
  ...
  getMarketplaceOrders = (
    ...
    return this.fetch(
      ...
      createHttpRequest(JsonEncode(req, 'GetMarketplaceOrdersRequest'), headers, signal)
    ).then(
      res => {
        return buildResponse(res).then(_data => {
  ...
  getMarketplaceTopOrders = (
    ...
    return this.fetch(
      ...
      createHttpRequest(JsonEncode(req, 'GetMarketplaceTopOrdersRequest'), headers, signal)
    ).then(
      res => {
        return buildResponse(res).then(_data => {
  ...
  getNativeTokenBalance = (
    ...
    return this.fetch(
      ...
      createHttpRequest(JsonEncode(req, 'GetNativeTokenBalanceRequest'), headers, signal)
    ).then(
      res => {
        return buildResponse(res).then(_data => {
  ...
  getPrices = (req: GetPricesRequest, headers?: object, signal?: AbortSignal): Promise<GetPricesResponse> => {
    return this.fetch(this.url('GetPrices'), createHttpRequest(JsonEncode(req, 'GetPricesRequest'), headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
  ...
  getTokenBalances = (
    ...
    return this.fetch(
      ...
      createHttpRequest(JsonEncode(req, 'GetTokenBalancesRequest'), headers, signal)
    ).then(
      res => {
        return buildResponse(res).then(_data => {
  ...
  getTokenBalancesByContract = (
    ...
    return this.fetch(
      ...
      createHttpRequest(JsonEncode(req, 'GetTokenBalancesByContractRequest'), headers, signal)
    ).then(
      res => {
        return buildResponse(res).then(_data => {
  ...
  getTokenBalancesDetails = (
    ...
    return this.fetch(
      ...
      createHttpRequest(JsonEncode(req, 'GetTokenBalancesDetailsRequest'), headers, signal)
    ).then(
      res => {
        return buildResponse(res).then(_data => {
  ...
  getTokenBalancesSummary = (
    ...
    return this.fetch(
      ...
      createHttpRequest(JsonEncode(req, 'GetTokenBalancesSummaryRequest'), headers, signal)
    ).then(
      res => {
        return buildResponse(res).then(_data => {
  ...
  getTokenIDRanges = (
    ...
    return this.fetch(
      ...
      createHttpRequest(JsonEncode(req, 'GetTokenIDRangesRequest'), headers, signal)
    ).then(
      res => {
        return buildResponse(res).then(_data => {
  ...
  getTokenIDs = (req: GetTokenIDsRequest, headers?: object, signal?: AbortSignal): Promise<GetTokenIDsResponse> => {
    return this.fetch(this.url('GetTokenIDs'), createHttpRequest(JsonEncode(req, 'GetTokenIDsRequest'), headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
  ...
  getTokenSupplies = (
    ...
    return this.fetch(
      ...
      createHttpRequest(JsonEncode(req, 'GetTokenSuppliesRequest'), headers, signal)
    ).then(
      res => {
        return buildResponse(res).then(_data => {
  ...
  getTokenSuppliesMap = (
    ...
    return this.fetch(
      ...
      createHttpRequest(JsonEncode(req, 'GetTokenSuppliesMapRequest'), headers, signal)
    ).then(
      res => {
        return buildResponse(res).then(_data => {
  ...
  getTransactionHistory = (
    ...
    return this.fetch(
      ...
      createHttpRequest(JsonEncode(req, 'GetTransactionHistoryRequest'), headers, signal)
    ).then(
      res => {
        return buildResponse(res).then(_data => {
  ...
  getWebhookListener = (
    ...
    return this.fetch(
      ...
      createHttpRequest(JsonEncode(req, 'GetWebhookListenerRequest'), headers, signal)
    ).then(
      res => {
        return buildResponse(res).then(_data => {
  ...
  pauseAllWebhookListeners = (
    ...
    return this.fetch(
      ...
      createHttpRequest(JsonEncode(req, 'PauseAllWebhookListenersRequest'), headers, signal)
    ).then(
      res => {
        return buildResponse(res).then(_data => {
  ...
  removeAllWebhookListeners = (
    ...
    return this.fetch(
      ...
      createHttpRequest(JsonEncode(req, 'RemoveAllWebhookListenersRequest'), headers, signal)
    ).then(
      res => {
        return buildResponse(res).then(_data => {
  ...
  removeWebhookListener = (
    ...
    return this.fetch(
      ...
      createHttpRequest(JsonEncode(req, 'RemoveWebhookListenerRequest'), headers, signal)
    ).then(
      res => {
        return buildResponse(res).then(_data => {
  ...
  resumeAllWebhookListeners = (
    ...
    return this.fetch(
      ...
      createHttpRequest(JsonEncode(req, 'ResumeAllWebhookListenersRequest'), headers, signal)
    ).then(
      res => {
        return buildResponse(res).then(_data => {
  ...
  subscribeBalanceUpdates = (
    ...
    const _fetch = () =>
      this.fetch(
        ...
        createHttpRequest(JsonEncode(req, 'SubscribeBalanceUpdatesRequest'), options.headers, abortSignal)
      ).then(
        async res => {
  ...
  subscribeEvents = (
    ...
    const _fetch = () =>
      this.fetch(
        this.url('SubscribeEvents'),
        createHttpRequest(JsonEncode(req, 'SubscribeEventsRequest'), options.headers, abortSignal)
      ).then(
        async res => {
          await sseResponse(res, options, _fetch)
        },
  ...
  subscribeReceipts = (
    ...
    const _fetch = () =>
      this.fetch(
        this.url('SubscribeReceipts'),
        createHttpRequest(JsonEncode(req, 'SubscribeReceiptsRequest'), options.headers, abortSignal)
      ).then(
        async res => {
          await sseResponse(res, options, _fetch)
        },
  ...
  syncBalance = (req: SyncBalanceRequest, headers?: object, signal?: AbortSignal): Promise<SyncBalanceResponse> => {
    return this.fetch(this.url('SyncBalance'), createHttpRequest(JsonEncode(req, 'SyncBalanceRequest'), headers, signal)).then(
      res => {
        return buildResponse(res).then(_data => {
  ...
  toggleWebhookListener = (
    ...
    return this.fetch(
      ...
      createHttpRequest(JsonEncode(req, 'ToggleWebhookListenerRequest'), headers, signal)
    ).then(
      res => {
        return buildResponse(res).then(_data => {
  ...
  updateWebhookListener = (
    ...
    return this.fetch(
      ...
      createHttpRequest(JsonEncode(req, 'UpdateWebhookListenerRequest'), headers, signal)
    ).then(
      res => {
        return buildResponse(res).then(_data => {
...
export const WebrpcHeaderValue = 'webrpc@v0.31.0;gen-typescript@v0.22.5;sequence-indexer@v0.4.0'
