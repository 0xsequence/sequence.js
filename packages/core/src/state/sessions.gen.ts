...
export const WebRPCSchemaHash = 'e8a95eea9b72a50abe2c3b10d8a51c5c3fd8c631'
...
export interface MigrationsReturn {
  migrations: {
    [key: string]: { [key: number]: { [key: string]: TransactionBundle } }
  }
}
        ...
        return buildResponse(res).then((_data) => {
          return {
            migrations: <
              {
                [key: string]: {
                  [key: number]: { [key: string]: TransactionBundle }
                }
              }
            >_data.migrations,
          }
