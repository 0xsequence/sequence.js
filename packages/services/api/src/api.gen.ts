/* eslint-disable */
// sequence-api v0.4.0 6c9da99a5ebb2f856fad1ae1c61da5221d5ba27f
// --
...
export const WebRPCSchemaHash = '6c9da99a5ebb2f856fad1ae1c61da5221d5ba27f'
...
export interface API {
   ...
   */
  createIntentConfig(
    args: CreateIntentConfigArgs,
    headers?: object,
    signal?: AbortSignal,
  ): Promise<CreateIntentConfigReturn>
...
export interface CreateIntentConfigArgs {
  userAddress: string
...
export interface CreateIntentConfigReturn {
  quote: IntentQuote
}
...
export class API implements API {
  ...
  createIntentConfig = (
    ...
    return this.fetch(this.url('CreateIntentConfig'), createHTTPRequest(args, headers, signal)).then(
      (res) => {
        return buildResponse(res).then((_data) => {
          return {
