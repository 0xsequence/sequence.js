/* eslint-disable */
// sequence-api v0.4.0 b899c1c0b2af8e48710440cec8b2d2a95acae9d1
// --
...
export const WebRPCSchemaHash = 'b899c1c0b2af8e48710440cec8b2d2a95acae9d1'
...
export interface IntentConfig {
  ...
  walletAddress: string
  mainSigner: string
  operations: Array<IntentOperation>
...
export interface API {
   ...
   */
  getIntentOperations(
    args: GetIntentOperationsArgs,
    headers?: object,
    signal?: AbortSignal,
  ): Promise<GetIntentOperationsReturn>
  commitIntentConfig(
...
export interface GetIntentOperationsArgs {
  userAddress: string
...
export interface GetIntentOperationsReturn {
  operations: Array<IntentOperation>
  preconditions: Array<IntentPrecondition>
  calls: Array<MetaTxn>
}
...
export class API implements API {
  ...
  getIntentOperations = (
    ...
    return this.fetch(this.url('GetIntentOperations'), createHTTPRequest(args, headers, signal)).then(
      (res) => {
        return buildResponse(res).then((_data) => {
          return {
            operations: <Array<IntentOperation>>_data.operations,
            preconditions: <Array<IntentPrecondition>>_data.preconditions,
            calls: <Array<MetaTxn>>_data.calls,
          }
        })
      },
      (error) => {
