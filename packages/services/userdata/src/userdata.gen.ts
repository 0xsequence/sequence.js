/* eslint-disable */
// userdata v0.1.0 1c37d1866dada9f3770a8ca37e790c7bcdb6424a
// --
...
export const WebrpcSchemaHash = '1c37d1866dada9f3770a8ca37e790c7bcdb6424a'
...
export interface UserDataClient {
  ...
  listActiveDevices(
    req: ListActiveDevicesRequest,
    headers?: object,
    signal?: AbortSignal,
  ): Promise<ListActiveDevicesResponse>

  putActiveDevice(req: PutActiveDeviceRequest, headers?: object, signal?: AbortSignal): Promise<PutActiveDeviceResponse>

  deleteActiveDevice(
    req: DeleteActiveDeviceRequest,
    headers?: object,
    signal?: AbortSignal,
  ): Promise<DeleteActiveDeviceResponse>
}
...
export interface ListActiveDevicesRequest {
  wallet: string
  pageSize: number
  cursor: string
}

export interface ListActiveDevicesResponse {
  devices: Array<ActiveDevice>
  nextCursor: string
}

export interface PutActiveDeviceRequest {
  wallet: string
  device: ActiveDeviceProps
}

export interface PutActiveDeviceResponse {
  device: ActiveDevice
}

export interface DeleteActiveDeviceRequest {
  wallet: string
  address: string
}

export interface DeleteActiveDeviceResponse {}
...
export class UserData implements UserDataClient {
  ...
  queryKey = {
    ...
    listActiveDevices: (req: ListActiveDevicesRequest) => ['UserData', 'listActiveDevices', req] as const,
    putActiveDevice: (req: PutActiveDeviceRequest) => ['UserData', 'putActiveDevice', req] as const,
    deleteActiveDevice: (req: DeleteActiveDeviceRequest) => ['UserData', 'deleteActiveDevice', req] as const,
  }
  ...
  listActiveDevices = (
    ...
    return this.fetch(
      this.url('ListActiveDevices'),
      createHttpRequest(JsonEncode(req, 'ListActiveDevicesRequest'), headers, signal),
    ).then(
      (res) => {
        return buildResponse(res).then((_data) => {
          return JsonDecode<ListActiveDevicesResponse>(_data, 'ListActiveDevicesResponse')
        })
      },
      (error) => {
        throw WebrpcRequestFailedError.new({
  ...
  putActiveDevice = (
    req: PutActiveDeviceRequest,
    headers?: object,
    signal?: AbortSignal,
  ): Promise<PutActiveDeviceResponse> => {
    return this.fetch(
      this.url('PutActiveDevice'),
      createHttpRequest(JsonEncode(req, 'PutActiveDeviceRequest'), headers, signal),
    ).then(
      (res) => {
        return buildResponse(res).then((_data) => {
          return JsonDecode<PutActiveDeviceResponse>(_data, 'PutActiveDeviceResponse')
        })
      },
      (error) => {
        throw WebrpcRequestFailedError.new({
  ...
  deleteActiveDevice = (
    ...
    return this.fetch(
      this.url('DeleteActiveDevice'),
      createHttpRequest(JsonEncode(req, 'DeleteActiveDeviceRequest'), headers, signal),
    ).then(
      (res) => {
        return buildResponse(res).then((_data) => {
          return JsonDecode<DeleteActiveDeviceResponse>(_data, 'DeleteActiveDeviceResponse')
        })
      },
      (error) => {
        throw WebrpcRequestFailedError.new({
