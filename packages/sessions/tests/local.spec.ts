...
const randomContext = () => {
  return {
    ...
    walletCreationCode: ethers.toBeHex(ethers.utils.randomBytes(32))
  }
}
    ...
    describe(name, () => {
      ...
      describe('Configuration', () => {
        ...
        it('Should return undefined for unknown imageHash', async () => {
          const imageHash = ethers.toBeHex(ethers.utils.randomBytes(32))
      ...
      describe('Handle witnesses', async () => {
        ...
        it('Should save a witness for a signer', async () => {
          ...
          const digest = ethers.toBeHex(ethers.utils.randomBytes(32))
          const signature = await wallet.signDigest(digest)
          ...
          const digest2 = ethers.toBeHex(ethers.utils.randomBytes(32))
          ...
          const digest3 = ethers.toBeHex(ethers.utils.randomBytes(32))
          const wallet2 = new Wallet({
            config,
            chainId: 2,
            coders: v2.coders,
