...
export const tests = async () => {
  ...
  await test('signTypedData on defaultChain', async () => {
    ...
    assert.equal(
      sig,
      '0x00010001051d5eddc0f6c4ecc09767ab9d5b8b20f4af7f6f8d24c7434a86a09da1ad2c7b40f57ea98209c589ff3e894b878ccdc4c5bb30b95c0cc9fe355aa86d169326d11c02',
  ...
  await test('signAuthMessage', async () => {
    ...
    assert.equal(
      sig,
      '0x000100013cd258afc2fb2fc8eceb3a098a77bffabd9e7fd93c266f2502dfa4114a8d3b2e42562670703771965c724816381e4de558d99d3e7c83e9037e86757388c8bfb91b02',
